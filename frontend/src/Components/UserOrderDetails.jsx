    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      <div className="w-full flex items-center justify-between pt-6">
        <h5 className="text-[#00000084]">
          Order ID: <span>#{data?._id?.slice(0, 24)}</span>
        </h5>
        <h5 className="text-[#00000084]">
        ...
        data?.cart.map((item, index) => {
          return (
            <div className="w-full flex items-start mb-5">
              <img
                src={`${background_url}/${item.images[0]}`}
                alt=""
      ...
      {open && (
        <div className="fixed top-0 left-0 h-screen bg-[#0005] z-50 flex items-center justify-center">
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-2">
            ...
            <h2 className="text-[28px] font-[500] font-Poppins text-center">
              Give a Review
            </h2>
            <br />
            <div className="w-full flex">
              <img
                src={`${background_url}/${selectedItem?.images[0]}`}
                alt=""
