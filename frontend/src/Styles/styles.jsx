const styles = {
  ...
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[yellow]",
  button:
    "w-[150px] bg-[#334139] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[green] flex items-center justify-center cursor-pointer",
